...
class Settings:
    ...
    REPO_SUMMARY_NEIGHBOR_LIMIT_EACH_DIRECTION: int
    ...
    def __init__(self) -> None:
        ...
        self.REPO_SUMMARY_NEIGHBOR_LIMIT_EACH_DIRECTION = int(
            os.getenv("REPO_SUMMARY_NEIGHBOR_LIMIT_EACH_DIRECTION", "15")
        )
        ...
        self.REPO_ARCHITECTURE_MERGE_TIMEOUT_SECONDS = int(os.getenv("REPO_ARCHITECTURE_MERGE_TIMEOUT_SECONDS", "90"))
        ...
        self.REPO_FULL_SUMMARY_TIMEOUT_SECONDS = int(os.getenv("REPO_FULL_SUMMARY_TIMEOUT_SECONDS", "90"))
        ...
        self.REPO_FULL_SUMMARY_MAX_ITERATIONS = int(os.getenv("REPO_FULL_SUMMARY_MAX_ITERATIONS", "10"))
