...
class Settings:
    ...
    REPO_SUMMARY_FAST_PATH_CHAR_THRESHOLD: int
    ...
    def __init__(self) -> None:
        ...
        self.REPO_SUMMARY_MAX_CONCURRENT_FILES = int(os.getenv("REPO_SUMMARY_MAX_CONCURRENT_FILES", "16"))
        self.REPO_SUMMARY_MAX_ITERATIONS = int(os.getenv("REPO_SUMMARY_MAX_ITERATIONS", "3"))
        self.REPO_SUMMARY_FAST_PATH_CHAR_THRESHOLD = int(os.getenv("REPO_SUMMARY_FAST_PATH_CHAR_THRESHOLD", "3000"))
        ...
        self.REPO_CONTEXT_RERANK_MODEL_NAME = os.getenv("REPO_CONTEXT_RERANK_MODEL_NAME", "gemini-3.1-flash-lite-preview")
        ...
        self.REPO_FULL_SUMMARY_TIMEOUT_SECONDS = int(os.getenv("REPO_FULL_SUMMARY_TIMEOUT_SECONDS", "600"))
