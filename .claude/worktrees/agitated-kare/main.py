...
_OPENAPI_TAGS = [
    {
        "name": "RepoKnowledge",
        "description": "Ingest repository source code into run-scoped relational tables.",
    },
    {
        "name": "RepoKnowledgeFileSummary",
        "description": "LLM-based per-file summarization runs over ingested repositories.",
    },
    {
        "name": "RepoKnowledgeRepoFullSummary",
        "description": "LLM-based repo-level README generation from completed file-summary runs.",
    },
    {
        "name": "RepoKnowledgeEmbedding",
        "description": "Embed file summaries into pgvector and retrieve context packs.",
    },
    {
        "name": "RepoKnowledgeRepoManager",
        "description": "Repo Manager: dependency-aware segmentation and per-segment architecture generation.",
    },
    {
        "name": "RepoKnowledgePipeline",
        "description": "Orchestrated pipeline that chains ingestion → file-summary → repo-full-summary → embedding → repo-manager.",
    },
    {
        "name": "Data",
        "description": "Generic key-value data ingestion and retrieval.",
    },
    {
        "name": "Documents",
        "description": "Document upload and chunk ingestion into the knowledge graph.",
    },
    {
        "name": "Threads",
        "description": "Conversation thread ingestion into the knowledge graph.",
    },
    {
        "name": "Search",
        "description": "Hybrid semantic + knowledge-graph search over ingested content.",
    },
]
...
app = FastAPI(
    ...
    version="0.1.0",
    description=(
        "Repository knowledge ingestion, LLM summarization, embedding, "
        "Repo Manager segmentation, and context-pack retrieval API."
    ),
